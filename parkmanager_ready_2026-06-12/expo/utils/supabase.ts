...
const DEFAULT_SUPABASE_URL = 'https://iqsddhzwapjkonrsbchz.supabase.co';
const DEFAULT_SUPABASE_ANON_KEY = 'sb_publishable_9RJm0JanqStaGOGHa7K7EA_e0PmwfWV';

const supabaseUrl = process.env.EXPO_PUBLIC_SUPABASE_URL || DEFAULT_SUPABASE_URL;
const supabaseKey = process.env.EXPO_PUBLIC_SUPABASE_ANON_KEY || DEFAULT_SUPABASE_ANON_KEY;
