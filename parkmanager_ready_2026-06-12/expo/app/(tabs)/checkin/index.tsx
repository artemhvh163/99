...
import { formatMoney, formatPlateNumber, getServiceTypeLabel, getMonthlyAmount, normalizePlateForSearch } from '@/utils/helpers';
...
const createStyles = (colors: ThemeColors) => StyleSheet.create({
  ...
  resultItemParked: { borderColor: colors.warning + '35' },
  resultInfo: { flex: 1 },
  resultPlate: { fontSize: 16, fontWeight: '700' as const, color: colors.text, letterSpacing: 0.3 },
  resultModel: { fontSize: 13, color: colors.textSecondary, marginTop: 3 },
  parkedExitBadge: {
    flexDirection: 'row', alignItems: 'center', gap: 5,
    backgroundColor: colors.warningSurface, borderRadius: 8, paddingHorizontal: 12, paddingVertical: 6,
  },
  parkedExitText: { fontSize: 12, color: colors.warning, fontWeight: '600' as const },
  newClientOptions: { marginTop: 10, gap: 8 },
  newClientBtn: {
    flexDirection: 'row' as const, alignItems: 'center' as const, gap: 10,
    backgroundColor: colors.primarySurface, borderRadius: 12,
    padding: 14, borderWidth: 1, borderColor: colors.primary + '15',
  },
  ...
  formTitle: { fontSize: 15, fontWeight: '600' as const, color: colors.text, marginBottom: 14 },
  formInput: {
  ...
  selectedCard: {
    ...
    padding: 14, marginBottom: 16, borderWidth: 1, borderColor: colors.primary + '15',
  },
  selectedPlate: { fontSize: 16, fontWeight: '700' as const, color: colors.text, letterSpacing: 0.3 },
  selectedName: { fontSize: 13, color: colors.textSecondary },
  changeBtn: { fontSize: 13, color: colors.primary, fontWeight: '600' as const },
  sectionLabel: { fontSize: 13, fontWeight: '600' as const, color: colors.textSecondary, marginBottom: 10, marginTop: 14, letterSpacing: 0.2, textTransform: 'uppercase' as const },
  ...
  lombardInfo: {
    ...
    backgroundColor: colors.warningSurface, borderRadius: 12,
    padding: 12, marginTop: 12, borderWidth: 1, borderColor: colors.warning + '15',
  },
  ...
  debtToggle: {
    flexDirection: 'row', alignItems: 'center', gap: 10,
    backgroundColor: colors.surface, borderRadius: 12,
    padding: 14, marginTop: 12, borderWidth: 1, borderColor: colors.border,
  },
  debtToggleActive: { backgroundColor: colors.dangerSurface, borderColor: colors.danger + '25' },
  ...
  customAmountToggleActive: {
    backgroundColor: 'rgba(167, 139, 250, 0.08)', borderColor: colors.adjustment + '25',
  },
  ...
  customAmountForm: {
    backgroundColor: colors.surface, borderRadius: 12,
    padding: 14, marginTop: 10, borderWidth: 1, borderColor: colors.adjustment + '20',
  },
  customAmountRow: { flexDirection: 'row', alignItems: 'center', gap: 12 },
  customAmountLabel: { fontSize: 13, color: colors.textSecondary },
  customAmountInput: {
    flex: 1, backgroundColor: colors.surfaceLight, borderRadius: 10,
    padding: 10, fontSize: 16, fontWeight: '700' as const, color: colors.text,
    textAlign: 'right' as const, borderWidth: 1, borderColor: colors.border,
  },
  adjustmentText: { fontSize: 12, fontWeight: '600' as const, marginTop: 8 },
  ...
  reasonInput: {
    ...
    padding: 10, fontSize: 13, color: colors.text, marginTop: 10,
    borderWidth: 1, borderColor: colors.border,
  },
  departureInput: {
    backgroundColor: colors.surface, borderRadius: 12,
    padding: 14, fontSize: 14, color: colors.text, marginTop: 14,
    borderWidth: 1, borderColor: colors.border,
  },
  noteInput: {
    backgroundColor: colors.surface, borderRadius: 12,
    padding: 14, fontSize: 14, color: colors.text, marginTop: 10,
  ...
  totalAmount: { fontSize: 28, fontWeight: '800' as const, color: colors.primary, marginTop: 6, letterSpacing: -0.5 },
  totalAmountDebt: { color: colors.danger },
  totalBase: { fontSize: 12, color: colors.textTertiary, marginTop: 6, textDecorationLine: 'line-through' as const },
  checkInBtn: {
    backgroundColor: colors.primary, borderRadius: 14,
    padding: 16, alignItems: 'center', marginTop: 18,
  },
  checkInBtnText: { fontSize: 16, fontWeight: '700' as const, color: colors.white },
  noResultText: { fontSize: 14, color: colors.textSecondary, marginBottom: 10 },
});
