...
import { buildEntitySearchQuery, formatMoney, formatDate, calculateDays, matchClientWithCars } from '@/utils/helpers';
  ...
  const sortedDebtors = useMemo(() => {
    ...
    if (search.trim()) {
      ...
      filtered = filtered.filter(item => {
        ...
        return matchClientWithCars(item.client, cars, query).matches;
      });
    }
