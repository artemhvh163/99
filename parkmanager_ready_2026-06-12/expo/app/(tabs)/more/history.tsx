...
import { buildEntitySearchQuery, formatMoney, formatDateTime, getMethodLabel, matchCarAndClientFields } from '@/utils/helpers';
  ...
  const filteredTx = useMemo(() => {
    ...
    return transactions.filter(t => {
      ...
      if (search.trim()) {
        ...
        if (!matchCarAndClientFields(car ?? undefined, client ?? undefined, query).matches) return false;
      }
