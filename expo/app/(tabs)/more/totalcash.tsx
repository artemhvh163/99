      ...
      {currentShift && currentShiftStats && (
        <View style={styles.section}>
            ...
            {currentShiftStats.cancelled > 0 && (
              <>
                ...
                <View style={styles.detailRow}>
                  ...
                  <Text style={styles.detailLabel}>Отмены оплат</Text>
                  <Text style={[styles.detailValue, { color: colors.warning }]}>
                    -{formatMoney(currentShiftStats.cancelled)}
                  </Text>
                </View>
              </>
            )}
          ...
          <View style={styles.summaryCard}>
            ...
            <Text style={styles.summaryValue} numberOfLines={1} adjustsFontSizeToFit>{formatMoney(currentShiftStats.calculatedBalance)}</Text>
          </View>
        </View>
      )}
