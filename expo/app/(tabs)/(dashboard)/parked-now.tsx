...
import { buildEntitySearchQuery, formatDateTime, calculateDays, getServiceTypeLabel, matchCarAndClient } from '@/utils/helpers';
  ...
  const filtered = useMemo(() => {
    ...
    if (search.trim()) {
      ...
      list = list.filter(s => {
        ...
        return matchCarAndClient(car, client, query).matches;
      });
    }
